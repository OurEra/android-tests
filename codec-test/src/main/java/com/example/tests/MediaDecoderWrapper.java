...
public class MediaDecoderWrapper {
    ...
    public interface OutputFormatChangedListener {
        void outputFormatChanged(MediaDecoderWrapper sender, MediaFormat newFormat);
    }
    ...
    public interface OutputSampleListener {
        void outputSample(MediaDecoderWrapper sender, MediaCodec.BufferInfo info, ByteBuffer buffer);
    }
    ...
    private MediaDecoderWrapper(MediaCodec codec) {
        mDecoder = codec;
        codec.start();
    ...
    /**
     * Constructs the {@link MediaDecoderWrapper} wrapper object around the video codec.
     ...
     * @return
     */
    public static MediaDecoderWrapper fromVideoFormat(final MediaFormat trackFormat,
            Surface surface) throws IOException {
        MediaDecoderWrapper result = null;
        ...
        if (mimeType.contains("video/")) {
            ...
            Log.i("MediaDecoderWrapper", "Use codec: " + videoCodec.getName());
        ...
        // newly created codec.
        if (videoCodec != null) {
            result = new MediaDecoderWrapper(videoCodec);
        }
    ...
    public boolean writeSample(final ByteBuffer input,
        ...
        if (size > 0 &&  !mAvailableInputBuffers.isEmpty()) {
            ...
            if (size > buffer.capacity()) {
                throw new MediaDecoderWrapper.WriteException(String.format(
     ...
     * OutputSampleListener#outputSample(MediaDecoderWrapper, android.media.MediaCodec.BufferInfo,
     * java.nio.ByteBuffer)}
     *
                        ...
                        mHandler.post(new Runnable() {
                            ...
                            public void run() {
                                mOutputFormatChangedListener
                                        .outputFormatChanged(MediaDecoderWrapper.this,
